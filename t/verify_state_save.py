...
def main():
    ...
    for ioengine in [aio, sync]:
        ...
        test_env['artifact_root'] = os.path.join(artifact_root, ioengine, "vssave")
        ...
        for test in TEST_LIST:
            ...
            directory = os.path.join(artifact_root, ioengine, "vssave", f"{test['test_id']:04d}")
        ...
        test_env['artifact_root'] = os.path.join(artifact_root, ioengine, "vonly")
        os.makedirs(test_env['artifact_root'])
